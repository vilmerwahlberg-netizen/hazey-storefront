(function () {
  ...
  window.HZ8.register("homepage-hero", function (context) {
    ...
    section.innerHTML = ''
      ...
      + '    <h1 id="hz8-hero-title"><span class="hz8-hero__title-line" data-line="1">Sveriges #1</span><br><span class="hz8-hero__title-line" data-line="2">för lagliga cannabinoider</span></h1>'
      + '    <p class="hz8-hero__lede">Noggrant testade och lagliga i Sverige – vi följer lagstiftningen löpande. Din trygghet först.</p>'
